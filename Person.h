...
public:
    ...
    Person(Sex _sex, const std::string& _name = "") :sex(_sex), name(_name) {
        children.clear();
        father = nullptr;
        mother = nullptr;
    };
    ...
    */
    bool hasChild(const Person* p) const;
    ...
    */
    ...
    Person* getChild(People::size_type index) const {
